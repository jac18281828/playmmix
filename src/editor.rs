...
impl Component for Editor {
    ...
    fn create(ctx: &Context<Self>) -> Self {
        Self {
            ...
            last_execution_stops: ctx.props().execution_stops,
    ...
    fn changed(&mut self, ctx: &Context<Self>, _old_props: &Self::Properties) -> bool {
        ...
        self.last_execution_stops = execution_stops;
        true
    }
...
fn should_follow_current_line(
    ...
    current_line.is_some() && execution_stops != last_execution_stops
}
...
mod tests {
    ...
    fn should_follow_current_line_matches_the_trigger_table() {
        ...
        let cases: [(u64, u64, Option<usize>, bool); 5] = [
            (0, 1, Some(9), true),  // T1
            (1, 1, Some(9), false), // T2: a re-render
            (1, 1, Some(4), false), // T3: an edit re-assembled
            (1, 2, Some(9), true),  // T4: a stop onto the line it left
            (1, 2, None, false),    // T5
        ];
    ...
    fn should_follow_current_line_follows_the_first_stop_after_page_load() {
        ...
        // unset. `create` itself is outside host reach -- `Editor` can't
        // mount host-side -- so this pins the trigger with the mount-time
        // count `create` seeds, then the first stop.
        let seeded_at_create = 0;
